...
public class StudController {
    ...
    @PostMapping("/students/updates")
    public String updateStudentsRDF(RedirectAttributes redirectAttributes) {
        List<Student> students = studentService.getAllStudents();
        // Print the fetched students

        String rdfFilePath = "C:\\Users\\yunus\\Downloads\\Telegram Desktop\\Lms (2)\\Lms (2)\\Lms(semn)\\Lms\\src\\main\\java\\com\\example\\Lms\\LMS\\controller\\student.rdf";

        try {
            StudRDFUpdater.updateRDFModel(students, rdfFilePath);
