...
public class CourseRDFUpdater {

    public static void updateRDFModel(List<Course> students, String rdfFilePath) throws IOException {
        ...
        for (Course student : students) {
            Resource studentResource = model.createResource(exNS + "student/" + student.getId())
                    .addProperty(nameProp, student.getName())
                    .addProperty(emailProp,  student.getCoursecode());
        }
